...
/**
 * Author: xueyunfeng
 * About:  半屏面板，固定高度200dp
 */
public class TestPanelFragment1 extends BasePanelFragment {
    ...
    protected int getContentLayoutResId() {
        return R.layout.fragment_test_panel1;
    }
    ...
    protected void initViews() {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                actionNextPanel(TestPanelFragment2.newBuilder(getContext(), null));
            }
        });
